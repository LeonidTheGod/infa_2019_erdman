...
class ball():
    ...
    def hittest(self, t1):
        ...
        if round(self.x) in range(t1.x - t1.r - self.r, t1.x + t1.r + self.r) \
        and round(self.y) in range(t1.y - t1.r - self.r, t1.y + t1.r + self.r):     
            # canv.delete(self.id_ball)
            return True
        return False
